...
import { CodeGenEngine } from '../src/generator/codegen-engine';
import { CodeGenRequest } from '../src/generator/structure-generator';
import { ConfigGenerator } from '../src/generator/config-generator';

describe('CodeGen Integration Tests', () => {
  let codegen: CodeGenEngine;
  let configGen: ConfigGenerator;

  beforeEach(() => {
    codegen = new CodeGenEngine();
  ...
  describe('Test 1: Express API + PostgreSQL', () => {
    it('should generate Express API project with PostgreSQL', async () => {
      ...
      console.log(
        `✅ Test 1 passed: ${Object.keys(fileMap).length} files generated in ${duration}ms`
      );
    });
  ...
  describe('Test 2: React + Node.js Full Stack', () => {
    it('should generate full-stack project with React frontend', async () => {
      ...
      console.log(
        `✅ Test 2 passed: React full-stack with ${Object.keys(fileMap).length} files`
      );
    });
  ...
  describe('Test 5: Dependency Auto-Resolution', () => {
    it('should add dependencies based on tech stack', async () => {
      ...
      console.log(
        `✅ Test 5 passed: ${Object.keys(packageJson.dependencies).length} dependencies added`
      );
    });
  ...
  describe('Test 8: Large Project Generation', () => {
    it('should generate 35+ files for complex project', async () => {
      const request: CodeGenRequest = {
        intent: 'create_api',
        project_type: 'api',
      ...
      // Generated code from codegen engine + config files
      expect(totalFiles).toBeGreaterThanOrEqual(35);
